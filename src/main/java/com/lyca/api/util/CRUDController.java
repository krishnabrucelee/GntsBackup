...
public class CRUDController<T> {
    ...
    @ResponseBody
    public T update(@RequestBody T t, @PathVariable("id") Integer id) throws Exception {
        return updateT(id, t);
    }
    ...
    @ResponseBody
    public T read(@PathVariable("id") Integer id) throws Exception {
        return get(id);
    }
     ...
     * @throws Exception if any issue occurs
     */
    protected T updateT(Integer id, T t) throws Exception {
        return t;
    }
     ...
     * @throws Exception if any issue occurs
     */
    protected void deleteT(Integer id) throws Exception {
        // Do nothing
    }
     ...
     * @throws Exception if any issue occurs
     */
    protected T get(Integer id) throws Exception {
        return null;
    }
